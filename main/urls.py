...
urlpatterns = [
    ...
    path('booking/<int:pk>/complaint/', views.create_complaint, name='create_complaint'),
    path('booking/<int:pk>/pdf/', views.download_booking_pdf, name='download_booking_pdf'),
